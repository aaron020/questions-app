from questions.add_database.database_service import DatabaseService
...
class TestDatabaseService:
    ...
    def test_convert_to_database_question(self):
        input_question: dict = {
                            'questions': 'What is the default and max retention period for messages in a queue?',
        ...
        assert database_question.get('questions') == 'What is the default and max retention period for messages in a queue?'
